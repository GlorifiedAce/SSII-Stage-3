...
That is why we went with a branching story instead of a slide deck or essay. There is no single right choice in the story, which is the same as in real life for these business owners and each ending is tied back to something specific from our research, so the story doesn't drift away from what we actually found.
...
**Explanation:** every ending comes with a short line connecting it to a specific piece of our research or an interview, so it is clear the story is not just made up for its own sake it is showing what we actually found, and staying focused on the investigation throughout.
